...
function processMedicalMessage(message) {
    ...
    if (symptoms.includes('headache')) {
        ...
        response += "• Rest in a quiet, dark room\n";
        response += "• Stay hydrated\n";
        response += "• Consider over-the-counter pain relievers\n";
        ...
        response += "• Monitor your temperature\n";
        response += "• Consider fever-reducing medication\n";
